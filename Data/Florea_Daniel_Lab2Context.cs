...
namespace Florea_Daniel_Lab2.Data
{
    public class Florea_Daniel_Lab2Context : DbContext
    {
        ...
        public DbSet<Florea_Daniel_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Florea_Daniel_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Florea_Daniel_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
