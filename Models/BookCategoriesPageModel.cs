...
namespace Florea_Daniel_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Florea_Daniel_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Florea_Daniel_Lab2Context context,
